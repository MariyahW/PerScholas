...
form.addEventListener("change", (event) => {
  ...
  if (selection == "cust") {
      ...
      if (event.target.value == "all") {
        ...
        sub.addEventListener("click", (event) => {
          ...
          (async function () {
            axios
              .get(
                `http://localhost:9999/customers/search?email=${event.target.form[0].value}`
              )
              .then((customers) => {
        ...
        sub.addEventListener("click", (event) => {
          ...
          (async function () {
            axios
              .get(
                `http://localhost:9999/customers/search?account=${event.target.form[0].value}`
              )
              .then((customers) => {
                console.log(customers);
                customers.data.forEach((customer) => {
    ...
    form.addEventListener("change", (event) => {
      //Selector with all or search account#
       if (event.target.value == "all") {
        add.innerHTML = "";
        (async function () {
          let table = document.createElement("table");
        ...
        sub.addEventListener("click", (event) => {
          ...
          (async function () {
            axios
              .get(
                `http://localhost:9999/accounts/${event.target.form[0].value}`
              )
              .then((customers) => {
                console.log(customers);
                customers.data.forEach((customer) => {
    ...
    form.addEventListener("change", (event) => {
      ...
      if (event.target.value == "all") {
        ...
        (async function () {
          let table = document.createElement("table");
          axios.get("http://localhost:9999/transactions").then((customers) => {
            // console.log(customers.data)
        ...
        sub.addEventListener("click", (event) => {
          ...
          (async function () {
            axios
              .get(
                `http://localhost:9999/transactions/${event.target.form[0].value}`
              )
              .then((customers) => {
                console.log(customers);
                customers.data.forEach((customer) => {
